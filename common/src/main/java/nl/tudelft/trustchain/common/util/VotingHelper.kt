...
class VotingHelper(
     ...
     */
    fun createProposal(voteSubject: String, peers: List<PublicKey>, mode: VotingMode, FOCProp: Boolean) {
    ...
    fun successfulFileProposals(): List<String> {
        ...
        val successFileProps = trustChainHelper.getBlocksByType(votingBlock)
            .filter {
                ...
                it.isProposal &&
                    ...
                    hasVotingBlockAttributeByKey(it, "FOC_FILE") && getVotingBlockAttributesByKey(it, "FOC_FILE") == "true" &&
        ...
        return successFileProps.map { getVotingBlockAttributesByKey(it, "VOTE_SUBJECT") }
    }
}
